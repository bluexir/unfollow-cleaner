...
export async function GET() {
  const manifest = {
    ...
    miniapp: {
      ...
      heroImageUrl: "https://unfollow-cleaner.vercel.app/icon.png",
      ...
      // ✅ Base preview'deki "noindex missing" hatasını çözer
      // false = aramalarda/keşifte görünsün
      noindex: false,

      public: true,

      // ✅ Farcaster + Base App uyumlu metinler
      subtitle: "Find your ghosts on Base & Farcaster",
      description:
